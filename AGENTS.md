...
- `envs/<env>/env.yaml` is the single source of truth; `build/<environment.id>/infra.tfvars.json` is generated by `make render-infra-vars` and should not be edited.
