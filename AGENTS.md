...
- Squid currently listens only on port `3128`; `bastion.squid_http_port` may be omitted or set to `3128`, and custom listener ports must fail configuration validation. Do not manage `http_port` in the distro Squid configuration.
