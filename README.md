...
The Markdown report embeds the infrastructure Mermaid diagram as its primary
visualization and summarizes key connectivity alongside concise support tables.
The terminal ASCII overview and Mermaid source remain standalone secondary
artifacts.
