...
Squid can optionally use one upstream parent proxy:
...
Without `proxy.upstream`, Squid connects to the Internet directly. With it,
Squid connects through the upstream proxy, while vCenter remains a DIRECT
destination.
