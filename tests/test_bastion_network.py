...
def test_inactive_competitor_with_expected_mac_is_only_disabled():
    actions = downstream_profile_actions(
        [{"uuid": "auto", "type": "ethernet", "device": "--", "mac_address": r"00\:11\:22\:33\:44\:55", "autoconnect": "yes"}],
        "managed",
        "00:11:22:33:44:55",
        ["ens256", "vlan565"],
    )
...
def test_disconnected_competitor_with_matching_interface_name_is_disabled():
    actions = downstream_profile_actions(
        [{"uuid": "auto", "type": "ethernet", "device": "--", "interface_name": "ens256", "mac_address": "", "autoconnect": "yes"}],
        "managed",
        "00:11:22:33:44:55",
        ["ens256"],
    )
...
def test_disconnected_competitor_matching_mac_and_interface_is_disabled():
    actions = downstream_profile_actions(
        [{"uuid": "vmware", "type": "802-3-ethernet", "device": "--", "interface_name": "ens256", "mac_address": r"00\:11\:22\:33\:44\:55", "autoconnect": "yes"}],
        "vlan565-uuid",
        "00:11:22:33:44:55",
        ["ens256"],
    )

    assert actions == {"disable": ["vmware"], "deactivate": []}
...
def test_managed_profile_and_other_nic_profiles_are_untouched():
    profiles = [
        {"uuid": "vlan565", "type": "ethernet", "device": "ens256", "interface_name": "ens256", "mac_address": r"00\:11\:22\:33\:44\:55", "autoconnect": "yes"},
        {"uuid": "other", "type": "ethernet", "device": "--", "interface_name": "ens161", "mac_address": r"00\:aa\:bb\:cc\:dd\:ee", "autoconnect": "yes"},
    ]

    assert downstream_profile_actions(profiles, "vlan565", "00:11:22:33:44:55", ["ens256"]) == {
        "disable": [],
        "deactivate": [],
    }


def test_multiple_downstream_nics_reconcile_competitors_independently():
    profiles = [
        {"uuid": "auto-256", "type": "ethernet", "device": "--", "interface_name": "ens256", "mac_address": r"00\:11\:22\:33\:44\:55", "autoconnect": "yes"},
        {"uuid": "auto-161", "type": "ethernet", "device": "--", "interface_name": "ens161", "mac_address": r"00\:aa\:bb\:cc\:dd\:ee", "autoconnect": "yes"},
    ]
    ...
    assert downstream_profile_actions(profiles, "vlan566", "00:aa:bb:cc:dd:ee", ["ens161"]) == {
        "disable": ["auto-161"],
        "deactivate": [],
    }
