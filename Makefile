...
help:
	...
	@printf '%s\n' '  bastion-configure   configure dnsmasq/squid/routes on bastion with pyinfra'
	...
	@printf '%s\n' '  rancher-install     install cert-manager and Rancher from bastion with pyinfra'
...
destroy-commands: instance-context
	...
	@printf '%s\n' '============================================================'
	@printf '%s\n' 'On a fresh checkout, initialize the GitLab backend first:'
